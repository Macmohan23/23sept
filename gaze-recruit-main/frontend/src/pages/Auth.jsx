...
import { User, Users, Mail, Lock, Phone } from "lucide-react";
...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    checkUser();
    // No realtime auth events; JWT is stored locally.
  }, [navigate]);
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || 'Signin failed',
        variant: "destructive"
      });
    } finally {
      setLoading(false);
  ...
  const handleGoogleSignIn = async () => {
    toast({ title: 'Not available', description: 'Google sign-in is disabled in local backend mode.' });
  };
